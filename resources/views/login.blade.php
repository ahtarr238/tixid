...
@section('content')
<div class="w-75 d-block m-auto my-5">
    ...
    <form method="POST" action="{{ route('login.auth') }}">
        {{-- mengirim data ke route log_in.send --}}
        {{-- token kunci di minta server biar formulir bisa mengirim data ke server/ke contrroler --}}
        @csrf
  <!-- Email input -->
  @error('email')
